...
int main() {
	inventory::warehouse *ware = new inventory::warehouse("Cincinati", "10/20/2010");

	string upc = "09234532";
	string upc1 = "2342143";
	string upc2 = "2342123";

	ware->receive(upc, 5, 30);
	...
	ware->receive(upc, 3, 25);
	ware->request(upc, 5);
	ware->next_day();
	
	ware->receive(upc1, 5, 40);
	ware->request(upc1, 21);
	ware->next_day();
	ware->receive(upc2, 3, 45);
